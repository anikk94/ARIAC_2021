...
from group6_rwa2.world_model import WorldModel
...
class Brain:
    ...
    def is_priority_order_being_processed(self):
        ...
        Returns:
            bool: returns True, if the priority order thread is alive and being processesed
        """
        flag = False
    ...
    def is_normal_order_being_processed(self):
        ...
        Returns:
            bool: return True, if the normal order thread is alive and being processed
        """
        flag = False
    ...
    def process_order_threads(self):
        """Handles the processing of orders simultaneously (normal order or a priority order)
        """
